...
import minia.chatapp.customapps.GetTimeAgo;
import minia.chatapp.models.Messages;
  ...
  //  private MessageAdapter mMessageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  mMessagesList.setAdapter(mMessageAdapter);
        ...
        //----ADDING LAST SEEN-----
        final SharedPreferences sharedPreferences = getSharedPreferences("type_f", MODE_PRIVATE);
        String type = sharedPreferences.getString("type_log", null);
