...
public class StatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences sharedPreferences = getSharedPreferences("type", MODE_PRIVATE);
        String type = sharedPreferences.getString("type_log", null);



            mDatabaseReference= FirebaseDatabase.getInstance().getReference().child("use").child(uid);
