...
public class employeeFragment extends Fragment {
    ...
    public employeeFragment(Long facultyId) {
    ...
    public void onStart() {
        ...
        mEmployeeDatabaseReference = FirebaseDatabase.getInstance().getReference("employees");
        ...
        mDepartmentDatabaseReference.orderByChild("facultyId").equalTo(facultyId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mEmployeeDatabaseReference.orderByChild("type").equalTo("employee").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
